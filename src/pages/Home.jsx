import headerImg from "../assets/edited.jpeg";
...
const Home = () => {
  return (<>
    <header className="px-[5%] py-4 sm:py-[50px] bg-white">
      <div className="flex flex-col items-center sm:flex-row sm:justify-center gap-5 sm:gap-[100px]">
        <div className="w-full sm:w-[500px] h-[300px] sm:h-[400px] relative" id="image-c">
          <img src={headerImg} alt="Elvis Kiarie" className="w-full h-full object-cover rounded-lg sm:rounded-none" />
        </div>
